...
class GDPR_Email {
	...
	public static function send( $emails, $type, $args = array(), $attachments = array() ) {
		$possible_types = apply_filters( 'gdpr_email_types', array(
			...
			'delete-resolved-notification'       => apply_filters( 'gdpr_delete_resolved_notification_email_subject', esc_html__( 'Some user account has been closed.', 'gdpr' ) ),
			...
			'export-data-resolved-notification'  => apply_filters( 'gdpr_export_data_resolved_notification_email_subject', esc_html__( 'Some user request has been completed.', 'gdpr' ) ),
